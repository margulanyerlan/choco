...
<html lang="en">
<head>
	<title>Check Rule Relevance</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="check_post.php" method="post" enctype="multipart/form-data">
	<span class="contact100-form-title">Check Rule Relevance</span>
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Rule</span>
					<div>
						<select class="selection-2" name="rule">
							<option>Select Rule</option>
							<?php
								$response = file_get_contents('http://127.0.0.1:8000/api/rules');
